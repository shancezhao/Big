...
//       Pattern ipPattern = Pattern.compile("([^a-zA-Z])+");
//       Matcher matcher = ipPattern.matcher(toAdd);
       if(toAdd.contains("Incertae sedis")||toAdd.contains("Incertae Sedis")|| toAdd.contains("[["))
           break;
//       if(matcher.find())
//           break;
       outlinks.add(toAdd); 
